    ...
    def move_morl_policy_verbose(self):
        ...
        for command in NEXT_STATES:
            ...
            for lookahead in NEXT_STATES:
                ...
                # we predict the value two steps into the fture
                for lookahead2 in NEXT_STATES:
                    lookahead_next_state2 = self.transition(lookahead_next_state, lookahead2)
                    expected_future_reward += self.compute_utility(lookahead_next_state2)
